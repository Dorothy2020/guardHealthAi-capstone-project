  ...
  "rounded-xl border text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        glass: "bg-card/80 backdrop-blur-lg border-border/50 shadow-md",
        gradient: "bg-gradient-to-br from-card to-secondary border-0 shadow-md",
        interactive: "bg-card shadow-sm hover:shadow-lg hover:-translate-y-1 cursor-pointer",
        risk: "bg-card shadow-md border-l-4",
      },
    },
    defaultVariants: {
      variant: "default",
